...
public class FetchSeasonTask extends AsyncTaskLoader<List<Season>> {


    private final Context mContext;
    private final int _id;

    public FetchSeasonTask(Context context, int i) {
        super(context);
        mContext = context;
        _id = i;
    }
    ...
    public List<Season> loadInBackground() {
        try {
            ...
            return TaskUtility.getJSONSeason(TaskUtility.getResponse(url),mContext);
